...
const files = '<link rel="stylesheet" href="../node_modules/mocha/mocha.css">' +
	'<link rel="stylesheet" href="../dist/ui-shared.css" />' +

	(/data-chart|export|us-map|demo-charts/.test(location.pathname)
	?
	'<link rel="stylesheet" href="../dist/data-chart.css" />'
	:
	...
	'<script src="./src/test-util.js"></script>' +
	'<script src="//localhost:35762/livereload.js"></script>';
